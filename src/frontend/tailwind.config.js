...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "card": "0 2px 16px rgba(46,90,167,0.07), 0 1px 4px rgba(0,0,0,0.04)",
        "card-hover": "0 16px 40px rgba(46,90,167,0.12), 0 4px 12px rgba(0,0,0,0.06)",
        "citrus": "0 8px 24px rgba(255,166,43,0.3)",
        "blue-soft": "0 4px 20px rgba(46,90,167,0.15)",
      },
      keyframes: {
        "accordion-down": { from: { height: "0" }, to: { height: "var(--radix-accordion-content-height)" } },
        "accordion-up": { from: { height: "var(--radix-accordion-content-height)" }, to: { height: "0" } },
        "fade-up": { "0%": { opacity: "0", transform: "translateY(24px)" }, "100%": { opacity: "1", transform: "translateY(0)" } },
        "gentle-float": { "0%, 100%": { transform: "translateY(0px)" }, "50%": { transform: "translateY(-10px)" } },
      },
      animation: {
